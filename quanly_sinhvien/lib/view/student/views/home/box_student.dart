...
import 'package:quanly_sinhvien/utils//convert.dart';
...
class BoxStudent extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
                ...
                Flexible(
                  child: Column(
                    children: <Widget>[
                      ...
                      _codeStudent(context, profile.username),
                      _major(context, profile.major)
                    ],
                  ),
                  flex: 2,
                ),
            ...
            _currentDate(context, bloc.dateTime),
          ],
        ),
      ),
    );
  ...
  _currentDate(BuildContext context, DateTime dateTime){
    final dayWeek= ApplicationConvert.convertDayWeek(dateTime.weekday);

    return Text('Today: $dayWeek, ${dateTime.day}/${dateTime.month}/${dateTime.year}'
      , style: Theme.of(context).primaryTextTheme.subtitle.copyWith(fontWeight: FontWeight.w400, fontStyle: FontStyle.italic),);
  }
  ...
  _fullName(BuildContext context, String name) {
    return Padding(
      ...
      child: Text(name, style: Theme.of(context).primaryTextTheme.subhead.copyWith(fontWeight: FontWeight.bold),),
    );
  }

  _codeStudent(BuildContext context, String username) {
    return Padding(
      padding: const EdgeInsets.only(top :8.0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: <Widget>[
          Text(AppLocalizations.of(context).tr('main_student.home.box_header.student_code')+":", style: Theme.of(context).primaryTextTheme.body2.copyWith(fontWeight: FontWeight.w400,
  ...
  _major(BuildContext context, String major) {
    return Padding(
      padding: const EdgeInsets.only(top :8.0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: <Widget>[
          Text(AppLocalizations.of(context).tr('main_student.home.box_header.major')+":", style: Theme.of(context).primaryTextTheme.body2.copyWith(fontWeight: FontWeight.w400,
              fontStyle: FontStyle.italic),),
          Text(major, style: Theme.of(context).primaryTextTheme.subtitle.copyWith(fontWeight: FontWeight.w600),),
        ],
      ),
    );
  }
